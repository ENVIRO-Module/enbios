...
class ProcessorAttributes:
    ...
    """
    def __init__(self, technology=None, region=None, scenario=None, time_=None):
        self.attrs = {}
        if technology:
    ...
    @staticmethod
    def partial_key(technology=None, region=None, scenario=None, time=None):
        d = {}
        if technology:
            d["_t"] = technology
        if region:
